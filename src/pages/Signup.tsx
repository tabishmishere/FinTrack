      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary flex-col justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-sm text-lg">
            Start your journey to financial freedom with smart tracking and
            insights.
          </p>
        </div>
      </div>
        ...
        <Card className="w-full max-w-md glass rounded-2xl border-border/30">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="rounded-xl border-border/40 bg-secondary hover:bg-secondary/80"
              >
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="rounded-xl border-border/40 bg-secondary"
                />
              </div>
              <div className="space-y-2">
                <Label>Email</Label>
              ...
              <Button
                type="submit"
                className="w-full gradient-primary rounded-xl text-primary-foreground glow-hover"
              >
                Create Account
              </Button>
            </form>
